...
import blue.repository.v1_2_0.conversation.AcceptChangeOperation;
import blue.repository.v1_2_0.conversation.AcceptChangeWorkflow;
import blue.repository.v1_2_0.conversation.Actor;
import blue.repository.v1_2_0.conversation.ActorPolicy;
import blue.repository.v1_2_0.conversation.AgentActor;
import blue.repository.v1_2_0.conversation.APICall;
import blue.repository.v1_2_0.conversation.BrowserSession;
import blue.repository.v1_2_0.conversation.ChangeOperation;
import blue.repository.v1_2_0.conversation.ChangeRequest;
import blue.repository.v1_2_0.conversation.ChangeWorkflow;
import blue.repository.v1_2_0.conversation.ChatMessage;
import blue.repository.v1_2_0.conversation.CompositeTimelineChannel;
import blue.repository.v1_2_0.conversation.ContractsChangePolicy;
import blue.repository.v1_2_0.conversation.CustomerActionRequested;
import blue.repository.v1_2_0.conversation.CustomerActionResponded;
import blue.repository.v1_2_0.conversation.CustomerConsent;
import blue.repository.v1_2_0.conversation.CustomerConsentRevoked;
import blue.repository.v1_2_0.conversation.DocumentBootstrapCompleted;
import blue.repository.v1_2_0.conversation.DocumentBootstrapFailed;
import blue.repository.v1_2_0.conversation.DocumentBootstrapRequested;
import blue.repository.v1_2_0.conversation.DocumentBootstrapResponded;
import blue.repository.v1_2_0.conversation.DocumentRequest;
import blue.repository.v1_2_0.conversation.DocumentSection;
import blue.repository.v1_2_0.conversation.DocumentSectionChangeEntry;
import blue.repository.v1_2_0.conversation.DocumentSectionChanges;
import blue.repository.v1_2_0.conversation.DocumentStatus;
import blue.repository.v1_2_0.conversation.Event;
import blue.repository.v1_2_0.conversation.InformUserAboutPendingAction;
import blue.repository.v1_2_0.conversation.JavaScriptCode;
import blue.repository.v1_2_0.conversation.LifecycleEvent;
import blue.repository.v1_2_0.conversation.Operation;
import blue.repository.v1_2_0.conversation.OperationRequest;
import blue.repository.v1_2_0.conversation.PrincipalActor;
import blue.repository.v1_2_0.conversation.ProposeChangeOperation;
import blue.repository.v1_2_0.conversation.ProposeChangeWorkflow;
import blue.repository.v1_2_0.conversation.ProposedChangeInvalid;
import blue.repository.v1_2_0.conversation.RejectChangeOperation;
import blue.repository.v1_2_0.conversation.RejectChangeWorkflow;
...
import blue.repository.v1_2_0.conversation.SequentialWorkflowStep;
import blue.repository.v1_2_0.conversation.Source;
import blue.repository.v1_2_0.conversation.StatusChange;
import blue.repository.v1_2_0.conversation.StatusCompleted;
import blue.repository.v1_2_0.conversation.StatusFailed;
import blue.repository.v1_2_0.conversation.StatusInProgress;
import blue.repository.v1_2_0.conversation.StatusPending;
...
import blue.repository.v1_2_0.conversation.TriggerEvent;
