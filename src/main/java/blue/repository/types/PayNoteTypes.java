...
import blue.repository.v1_2_0.paynote.CancelBeforeCompletionRequested;
import blue.repository.v1_2_0.paynote.CaptureDeclined;
import blue.repository.v1_2_0.paynote.CaptureFailed;
import blue.repository.v1_2_0.paynote.CaptureFundsRequested;
import blue.repository.v1_2_0.paynote.CardChargeCompleted;
import blue.repository.v1_2_0.paynote.CardChargeResponded;
import blue.repository.v1_2_0.paynote.CardTransactionCaptureLockChangeFailed;
import blue.repository.v1_2_0.paynote.CardTransactionCaptureLockRequested;
import blue.repository.v1_2_0.paynote.CardTransactionCaptureLocked;
import blue.repository.v1_2_0.paynote.CardTransactionCaptureUnlockRequested;
import blue.repository.v1_2_0.paynote.CardTransactionCaptureUnlocked;
import blue.repository.v1_2_0.paynote.CardTransactionDetails;
import blue.repository.v1_2_0.paynote.CardTransactionMonitoringRequestRejected;
import blue.repository.v1_2_0.paynote.CardTransactionMonitoringStarted;
import blue.repository.v1_2_0.paynote.CardTransactionMonitoringStopped;
import blue.repository.v1_2_0.paynote.CardTransactionPayNote;
import blue.repository.v1_2_0.paynote.CardTransactionReport;
import blue.repository.v1_2_0.paynote.ChildPayNoteIssuanceDeclined;
import blue.repository.v1_2_0.paynote.ChildPayNoteIssued;
import blue.repository.v1_2_0.paynote.CompletePaymentRequested;
import blue.repository.v1_2_0.paynote.FinalAmountResolutionRejected;
import blue.repository.v1_2_0.paynote.FinalAmountResolutionRequested;
import blue.repository.v1_2_0.paynote.FinalAmountResolved;
import blue.repository.v1_2_0.paynote.FundsCaptured;
import blue.repository.v1_2_0.paynote.FundsReserved;
import blue.repository.v1_2_0.paynote.FundsSecured;
import blue.repository.v1_2_0.paynote.FundsSecuringDeclined;
import blue.repository.v1_2_0.paynote.FundsSecuringFailed;
import blue.repository.v1_2_0.paynote.IssueChildPayNoteRequested;
import blue.repository.v1_2_0.paynote.LinkedCardChargeAndCaptureImmediatelyRequested;
import blue.repository.v1_2_0.paynote.LinkedCardChargeRequested;
import blue.repository.v1_2_0.paynote.LinkedPayNoteStartFailed;
import blue.repository.v1_2_0.paynote.LinkedPayNoteStartResponded;
import blue.repository.v1_2_0.paynote.LinkedPayNoteStarted;
import blue.repository.v1_2_0.paynote.MerchantToCustomerPayNote;
import blue.repository.v1_2_0.paynote.PayeeAssignmentConfirmed;
import blue.repository.v1_2_0.paynote.PayeeAssignmentRejected;
import blue.repository.v1_2_0.paynote.PayeeAssignmentRequested;
import blue.repository.v1_2_0.paynote.PaymentCancellationDeclined;
import blue.repository.v1_2_0.paynote.PaymentCancellationFailed;
import blue.repository.v1_2_0.paynote.PaymentCancelledBeforeCompletion;
import blue.repository.v1_2_0.paynote.PaymentCompleted;
import blue.repository.v1_2_0.paynote.PaymentCompletionDeclined;
import blue.repository.v1_2_0.paynote.PaymentCompletionFailed;
import blue.repository.v1_2_0.paynote.PaymentCompletionLockChangeFailed;
import blue.repository.v1_2_0.paynote.PaymentCompletionLockRequested;
import blue.repository.v1_2_0.paynote.PaymentCompletionLocked;
import blue.repository.v1_2_0.paynote.PaymentCompletionUnlockRequested;
import blue.repository.v1_2_0.paynote.PaymentCompletionUnlocked;
import blue.repository.v1_2_0.paynote.PaymentMandate;
import blue.repository.v1_2_0.paynote.PaymentMandateAttached;
import blue.repository.v1_2_0.paynote.PaymentMandateAttachmentFailed;
import blue.repository.v1_2_0.paynote.PaymentMandateSpendAuthorizationRequested;
import blue.repository.v1_2_0.paynote.PaymentMandateSpendAuthorizationResponded;
import blue.repository.v1_2_0.paynote.PaymentMandateSpendSettled;
import blue.repository.v1_2_0.paynote.PaymentMandateSpendSettlementResponded;
import blue.repository.v1_2_0.paynote.PaymentReversalDeclined;
import blue.repository.v1_2_0.paynote.PaymentReversalFailed;
import blue.repository.v1_2_0.paynote.PaymentReversalLockChangeFailed;
import blue.repository.v1_2_0.paynote.PaymentReversalLockRequested;
import blue.repository.v1_2_0.paynote.PaymentReversalLocked;
import blue.repository.v1_2_0.paynote.PaymentReversalUnlockRequested;
import blue.repository.v1_2_0.paynote.PaymentReversalUnlocked;
import blue.repository.v1_2_0.paynote.PaymentReversedAfterCompletion;
import blue.repository.v1_2_0.paynote.PayNote;
import blue.repository.v1_2_0.paynote.PayNoteAcceptanceRequested;
import blue.repository.v1_2_0.paynote.PayNoteAccepted;
import blue.repository.v1_2_0.paynote.PayNoteAcceptedByClient;
import blue.repository.v1_2_0.paynote.PayNoteApproved;
import blue.repository.v1_2_0.paynote.PayNoteCancellationRejected;
import blue.repository.v1_2_0.paynote.PayNoteCancellationRequested;
import blue.repository.v1_2_0.paynote.PayNoteCancelled;
import blue.repository.v1_2_0.paynote.PayNoteClientDecisionDiscarded;
import blue.repository.v1_2_0.paynote.PayNoteDelivery;
import blue.repository.v1_2_0.paynote.PayNoteDeliveryFailed;
import blue.repository.v1_2_0.paynote.PayNoteRejected;
import blue.repository.v1_2_0.paynote.PayNoteRejectedByClient;
import blue.repository.v1_2_0.paynote.ReservationDeclined;
import blue.repository.v1_2_0.paynote.ReservationReleaseDeclined;
import blue.repository.v1_2_0.paynote.ReservationReleaseRequested;
import blue.repository.v1_2_0.paynote.ReservationReleased;
import blue.repository.v1_2_0.paynote.ReserveFundsAndCaptureImmediatelyRequested;
import blue.repository.v1_2_0.paynote.ReserveFundsRequested;
import blue.repository.v1_2_0.paynote.ReverseAfterCompletionRequested;
import blue.repository.v1_2_0.paynote.ReverseCardChargeAndCaptureImmediatelyRequested;
import blue.repository.v1_2_0.paynote.ReverseCardChargeRequested;
import blue.repository.v1_2_0.paynote.SecureFundsRequested;
import blue.repository.v1_2_0.paynote.SettlementAmountRejected;
import blue.repository.v1_2_0.paynote.SettlementAmountSpecified;
import blue.repository.v1_2_0.paynote.StartCardTransactionMonitoringRequested;
import blue.repository.v1_2_0.paynote.TransactionDetailsUpdateFailed;
import blue.repository.v1_2_0.paynote.TransactionDetailsUpdateLockChangeFailed;
import blue.repository.v1_2_0.paynote.TransactionDetailsUpdateLockRequested;
import blue.repository.v1_2_0.paynote.TransactionDetailsUpdateLocked;
import blue.repository.v1_2_0.paynote.TransactionDetailsUpdateRejected;
import blue.repository.v1_2_0.paynote.TransactionDetailsUpdateRequested;
import blue.repository.v1_2_0.paynote.TransactionDetailsUpdateUnlockRequested;
import blue.repository.v1_2_0.paynote.TransactionDetailsUpdateUnlocked;
import blue.repository.v1_2_0.paynote.TransactionDetailsUpdated;
import blue.repository.v1_2_0.paynote.TransactionIdentificationFailed;
import blue.repository.v1_2_0.paynote.TransactionIdentified;
import blue.repository.v1_2_0.paynote.TransactionInitiated;
import blue.repository.v1_2_0.paynote.TransactionInitiationFailed;
import blue.repository.v1_2_0.paynote.TransactionStatus;
