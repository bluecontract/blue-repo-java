...
import blue.repo.v1_3_0.conversation.AcceptChangeOperation;
import blue.repo.v1_3_0.conversation.AcceptChangeWorkflow;
import blue.repo.v1_3_0.conversation.Actor;
import blue.repo.v1_3_0.conversation.ActorPolicy;
import blue.repo.v1_3_0.conversation.AgentActor;
import blue.repo.v1_3_0.conversation.APICall;
import blue.repo.v1_3_0.conversation.BrowserSession;
import blue.repo.v1_3_0.conversation.ChangeOperation;
import blue.repo.v1_3_0.conversation.ChangeRequest;
import blue.repo.v1_3_0.conversation.ChangeWorkflow;
import blue.repo.v1_3_0.conversation.ChatMessage;
import blue.repo.v1_3_0.conversation.CompositeTimelineChannel;
import blue.repo.v1_3_0.conversation.ContractsChangePolicy;
import blue.repo.v1_3_0.conversation.CustomerActionRequested;
import blue.repo.v1_3_0.conversation.CustomerActionResponded;
import blue.repo.v1_3_0.conversation.CustomerConsent;
import blue.repo.v1_3_0.conversation.CustomerConsentRevoked;
import blue.repo.v1_3_0.conversation.DocumentBootstrapCompleted;
import blue.repo.v1_3_0.conversation.DocumentBootstrapFailed;
import blue.repo.v1_3_0.conversation.DocumentBootstrapRequested;
import blue.repo.v1_3_0.conversation.DocumentBootstrapResponded;
import blue.repo.v1_3_0.conversation.DocumentRequest;
import blue.repo.v1_3_0.conversation.DocumentSection;
import blue.repo.v1_3_0.conversation.DocumentSectionChangeEntry;
import blue.repo.v1_3_0.conversation.DocumentSectionChanges;
import blue.repo.v1_3_0.conversation.DocumentStatus;
import blue.repo.v1_3_0.conversation.Event;
import blue.repo.v1_3_0.conversation.InformUserAboutPendingAction;
import blue.repo.v1_3_0.conversation.JavaScriptCode;
import blue.repo.v1_3_0.conversation.LifecycleEvent;
import blue.repo.v1_3_0.conversation.Operation;
import blue.repo.v1_3_0.conversation.OperationRequest;
import blue.repo.v1_3_0.conversation.PrincipalActor;
import blue.repo.v1_3_0.conversation.ProposeChangeOperation;
import blue.repo.v1_3_0.conversation.ProposeChangeWorkflow;
import blue.repo.v1_3_0.conversation.ProposedChangeInvalid;
import blue.repo.v1_3_0.conversation.RejectChangeOperation;
import blue.repo.v1_3_0.conversation.RejectChangeWorkflow;
...
import blue.repo.v1_3_0.conversation.Source;
import blue.repo.v1_3_0.conversation.StatusChange;
import blue.repo.v1_3_0.conversation.StatusCompleted;
import blue.repo.v1_3_0.conversation.StatusFailed;
import blue.repo.v1_3_0.conversation.StatusInProgress;
import blue.repo.v1_3_0.conversation.StatusPending;
