...
import blue.repo.v1_2_0.myos.AddingParticipantRequested;
import blue.repo.v1_2_0.myos.AddingParticipantResponded;
import blue.repo.v1_2_0.myos.Agent;
import blue.repo.v1_2_0.myos.AgentActor;
import blue.repo.v1_2_0.myos.AllParticipantsReady;
import blue.repo.v1_2_0.myos.AnchorAutomationTemplate;
import blue.repo.v1_2_0.myos.BootstrapFailed;
import blue.repo.v1_2_0.myos.CallOperationAccepted;
import blue.repo.v1_2_0.myos.CallOperationFailed;
import blue.repo.v1_2_0.myos.CallOperationRequested;
import blue.repo.v1_2_0.myos.CallOperationResponded;
import blue.repo.v1_2_0.myos.ChatGPTConnectorAgent;
import blue.repo.v1_2_0.myos.DocumentAnchor;
import blue.repo.v1_2_0.myos.DocumentAnchors;
import blue.repo.v1_2_0.myos.DocumentInitialSnapshotRequested;
import blue.repo.v1_2_0.myos.DocumentInitialSnapshotResolved;
import blue.repo.v1_2_0.myos.DocumentInitialSnapshotUnresolved;
import blue.repo.v1_2_0.myos.DocumentLink;
import blue.repo.v1_2_0.myos.DocumentLinks;
import blue.repo.v1_2_0.myos.DocumentSessionBootstrap;
import blue.repo.v1_2_0.myos.DocumentTypeLink;
import blue.repo.v1_2_0.myos.InformUserToInstallMyOSPackage;
import blue.repo.v1_2_0.myos.Link;
import blue.repo.v1_2_0.myos.LinkedDocumentsPermissionGrantRequested;
import blue.repo.v1_2_0.myos.LinkedDocumentsPermissionGrantToAccount;
import blue.repo.v1_2_0.myos.LinkedDocumentsPermissionGrantToDocument;
import blue.repo.v1_2_0.myos.LinkedDocumentsPermissionGranted;
import blue.repo.v1_2_0.myos.LinkedDocumentsPermissionGrantingInProgress;
import blue.repo.v1_2_0.myos.LinkedDocumentsPermissionInvalid;
import blue.repo.v1_2_0.myos.LinkedDocumentsPermissionRejected;
import blue.repo.v1_2_0.myos.LinkedDocumentsPermissionRevokeRequested;
import blue.repo.v1_2_0.myos.LinkedDocumentsPermissionRevoked;
import blue.repo.v1_2_0.myos.LinkedDocumentsPermissionRevokingInProgress;
import blue.repo.v1_2_0.myos.LinkedDocumentsPermissionSet;
import blue.repo.v1_2_0.myos.LinkedDocumentsPermissionValidated;
import blue.repo.v1_2_0.myos.LLMAgent;
import blue.repo.v1_2_0.myos.MyOSAdminBase;
import blue.repo.v1_2_0.myos.MyOSAgent;
import blue.repo.v1_2_0.myos.MyOSAgentActor;
import blue.repo.v1_2_0.myos.MyOSAgentChannel;
import blue.repo.v1_2_0.myos.MyOSAgentEvent;
import blue.repo.v1_2_0.myos.MyOSBalanceAccount;
import blue.repo.v1_2_0.myos.MyOSDocumentSessionReference;
import blue.repo.v1_2_0.myos.MyOSPackage;
import blue.repo.v1_2_0.myos.MyOSParticipantsOrchestration;
import blue.repo.v1_2_0.myos.MyOSPrincipalActor;
import blue.repo.v1_2_0.myos.MyOSSessionInteraction;
import blue.repo.v1_2_0.myos.MyOSSessionLink;
import blue.repo.v1_2_0.myos.MyOSTimeline;
import blue.repo.v1_2_0.myos.MyOSTimelineChannel;
import blue.repo.v1_2_0.myos.MyOSTimelineEntry;
import blue.repo.v1_2_0.myos.MyOSUser;
import blue.repo.v1_2_0.myos.MyOSWorkerAgency;
import blue.repo.v1_2_0.myos.Participant;
import blue.repo.v1_2_0.myos.ParticipantActivated;
import blue.repo.v1_2_0.myos.ParticipantActivationState;
import blue.repo.v1_2_0.myos.ParticipantResolved;
import blue.repo.v1_2_0.myos.PaymentInitiated;
import blue.repo.v1_2_0.myos.PaymentInitiationAccepted;
import blue.repo.v1_2_0.myos.PaymentInitiationRejected;
import blue.repo.v1_2_0.myos.PaymentInitiationRequested;
import blue.repo.v1_2_0.myos.PaymentTargetPreparationFailed;
import blue.repo.v1_2_0.myos.PaymentTargetPreparationRequested;
import blue.repo.v1_2_0.myos.PaymentTargetPrepared;
import blue.repo.v1_2_0.myos.PrincipalActor;
import blue.repo.v1_2_0.myos.RemovingParticipantRequested;
import blue.repo.v1_2_0.myos.RemovingParticipantResponded;
import blue.repo.v1_2_0.myos.SearchContract;
import blue.repo.v1_2_0.myos.SessionEpochAdvanced;
import blue.repo.v1_2_0.myos.SingleDocumentPermissionGrantRequested;
import blue.repo.v1_2_0.myos.SingleDocumentPermissionGrantResponded;
import blue.repo.v1_2_0.myos.SingleDocumentPermissionGrantToAccount;
import blue.repo.v1_2_0.myos.SingleDocumentPermissionGrantToDocument;
import blue.repo.v1_2_0.myos.SingleDocumentPermissionGranted;
import blue.repo.v1_2_0.myos.SingleDocumentPermissionGrantingInProgress;
import blue.repo.v1_2_0.myos.SingleDocumentPermissionInvalid;
import blue.repo.v1_2_0.myos.SingleDocumentPermissionRejected;
import blue.repo.v1_2_0.myos.SingleDocumentPermissionRevokeRequested;
import blue.repo.v1_2_0.myos.SingleDocumentPermissionRevoked;
import blue.repo.v1_2_0.myos.SingleDocumentPermissionRevokingInProgress;
import blue.repo.v1_2_0.myos.SingleDocumentPermissionSet;
import blue.repo.v1_2_0.myos.SingleDocumentPermissionValidated;
import blue.repo.v1_2_0.myos.StartWorkerSessionRequested;
import blue.repo.v1_2_0.myos.SubscribeToSessionRequested;
import blue.repo.v1_2_0.myos.SubscriptionToSessionFailed;
import blue.repo.v1_2_0.myos.SubscriptionToSessionInitiated;
import blue.repo.v1_2_0.myos.SubscriptionToSessionRevoked;
import blue.repo.v1_2_0.myos.SubscriptionUpdate;
import blue.repo.v1_2_0.myos.TargetDocumentSessionStarted;
import blue.repo.v1_2_0.myos.WorkerAgencyPermission;
import blue.repo.v1_2_0.myos.WorkerAgencyPermissionGrant;
import blue.repo.v1_2_0.myos.WorkerAgencyPermissionGrantRequested;
import blue.repo.v1_2_0.myos.WorkerAgencyPermissionGranted;
import blue.repo.v1_2_0.myos.WorkerAgencyPermissionGrantingInProgress;
import blue.repo.v1_2_0.myos.WorkerAgencyPermissionInvalid;
import blue.repo.v1_2_0.myos.WorkerAgencyPermissionRejected;
import blue.repo.v1_2_0.myos.WorkerAgencyPermissionRevokeRequested;
import blue.repo.v1_2_0.myos.WorkerAgencyPermissionRevoked;
import blue.repo.v1_2_0.myos.WorkerAgencyPermissionRevokingInProgress;
import blue.repo.v1_2_0.myos.WorkerAgencyPermissionValidated;
import blue.repo.v1_2_0.myos.WorkerSessionStarting;
